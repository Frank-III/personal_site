...
function Developer() {
  return (
    <span className="group">
      ...
      <span className="invisible inline-flex text-zinc-300 before:content-['|'] group-hover:visible group-hover:animate-typing" />
    </span>
  )
}
...
function Self() {
    ...
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className='mr-1 inline-flex group-hover:fill-zinc-600/100'
    >
      <path
...
export default function Header() {
  return (
    <motion.h1
        className="font-semibold tracking-tight text-zinc-300 sm:text-3xl"
