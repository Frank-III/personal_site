...
{#if mounted}
	<h1
		class="font-semibold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-3xl"
		in:fly={{ y: 30, duration: 600, easing: quintOut }}
	>
		<span class="group">
			<span class="font-mono">&lt;</span>Developer<span class="font-mono">/&gt;</span>
			<span class="invisible inline-flex text-zinc-300 dark:text-zinc-500 before:content-['|'] group-hover:visible group-hover:animate-typing" />
		</span>，

		<span class="group relative rounded-2xl bg-black/5 p-1 dark:bg-white/5">
			<span class="pointer-events-none absolute inset-0 border border-lime-700/90 opacity-70 group-hover:border-dashed group-hover:opacity-100 dark:border-lime-400/90">
				<span class="absolute -left-0.5 -top-0.5 h-1.5 w-1.5 border border-lime-700 bg-zinc-50 dark:border-lime-400" />
				<span class="absolute -bottom-0.5 -right-0.5 h-1.5 w-1.5 border border-lime-700 bg-zinc-50 dark:border-lime-400" />
				<span class="absolute -bottom-0.5 -left-0.5 h-1.5 w-1.5 border border-lime-700 bg-zinc-50 dark:border-lime-400" />
				<span class="absolute -right-0.5 -top-0.5 h-1.5 w-1.5 border border-lime-700 bg-zinc-50 dark:border-lime-400" />
			</span>
			Structurer
		</span>，
		<br />
